...
public class GraphicsPanel extends JPanel implements KeyListener{
	...
	public GraphicsPanel(){
		...
		katze = new Sprite("sprite/skinwalker/", 50,368,100,1,1); // change file path
	...
	public void keyPressed(KeyEvent e) {
		if(!skinWalker.isDead&&!katze.isDead) {
			...
			//		skinWalker.run();
				...
				else p2Attack = new Item(katze.x_coordinate+250, katze.y_coordinate, "images/objects/signArrow.png", 1); // images 
				...
				katze = new Sprite("sprite/skinwalker/", 50,550,50,2,3);
			}
			else if(e.getKeyCode()==KeyEvent.VK_2) {
				katze = new Sprite("sprite/skinwalker/", 50,550,150,.5,2);
			}
			else if(e.getKeyCode()==KeyEvent.VK_3) {
				katze = new Sprite("sprite/skinwalker/", 50,550,100,1,2);
			}
